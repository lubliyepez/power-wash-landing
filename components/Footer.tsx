...
export default function Footer() {
  return (
    <footer className="bg-[#0b1329] border-t border-slate-800/50 py-8 text-gray-400 text-sm">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1">&copy; {new Date().getFullYear()} PremiumWash. All rights reserved.</p>
        </div>
